...
# Cloudflare Pages _redirects. The four per-city pages were removed on 2026-09-24 and
# replaced by cities.html + city.html?locality=<slug>. Without this, those URLs are SOFT
# 404s on this domain — HTTP 200 with the homepage — which is the worst answer for a
# bookmark, a search engine, or anyone following an old link: it looks like it worked.
# 301 because the pages are gone for good.
cat > "$OUT/_redirects" <<'REDIR'
# generated by build.sh — do not edit here, edit build.sh
/city-barcelona    /cities  301
/city-boston       /cities  301
/city-bali         /cities  301
/city-santiago     /cities  301
/city-barcelona.html  /cities  301
